...
// 	expectedTransactions := []adminDto.Transaction{
// 		{
// 			TransactionId:   "1",
...
// 	mockRepo.On("GetTransaction", page, limit).Return(expectedTransactions, expectedTotal, nil)

// 	transactions, total, err := usecase.GetTransaction(page, limit)
...
// 	mockRepo.On("GetTransaction", page, limit).Return(nil, 0, expectedError)
...
// func TestGetTopUpTransaction_Success(t *testing.T) {
// 	mockRepo := new(MockAdminRepository)
// 	usecase := adminUsecase.NewAdminUsecase(mockRepo)
...
// 	expectedTransactions := []adminDto.TopUpTransaction{
// 		{
// 			TransactionId:   "1",
// 			UserId:          "user1",
// 			Amount:          "100",
...
// 	mockRepo.On("GetTopUpTransaction", page, limit).Return(expectedTransactions, expectedTotal, nil)

// 	transactions, total, err := usecase.GetTopUpTransaction(page, limit)
...
// func TestGetTopUpTransaction_Failure(t *testing.T) {
// 	mockRepo := new(MockAdminRepository)
// 	usecase := adminUsecase.NewAdminUsecase(mockRepo)
...
// 	mockRepo.On("GetTopUpTransaction", page, limit).Return(nil, 0, expectedError)
...
// func TestGetWalletTransaction_Success(t *testing.T) {
// 	mockRepo := new(MockAdminRepository)
// 	usecase := adminUsecase.NewAdminUsecase(mockRepo)
...
// 	expectedTransactions := []adminDto.WalletTransaction{
// 		{
// 			TransactionId:   "1",
...
// 	mockRepo.On("GetWalletTransaction", page, limit).Return(expectedTransactions, expectedTotal, nil)

// 	transactions, total, err := usecase.GetWalletTransaction(page, limit)
...
// func TestGetWalletTransaction_Failure(t *testing.T) {
// 	mockRepo := new(MockAdminRepository)
// 	usecase := adminUsecase.NewAdminUsecase(mockRepo)
...
// 	mockRepo.On("GetWalletTransaction", page, limit).Return(nil, 0, expectedError)
